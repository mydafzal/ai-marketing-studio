...
export default function FacebookConnect() {
  ...
  return (
    <button 
      ...
      className="h-12 px-6 flex items-center justify-center bg-[#1A77F2] text-white rounded-md shadow-md transition-transform transform hover:scale-105 active:scale-100 focus:outline-none font-bold text-base"
    >
      <svg 
