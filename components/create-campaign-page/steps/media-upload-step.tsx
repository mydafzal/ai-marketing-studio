...
export function MediaUploadStep({
  ...
  return (
    <>
      ...
      <AIMessageWithTyping message="Let's start by uploading your creative content! Upload images or videos that will be used in your campaign. High-quality visuals work best for engagement." />
