...
export function Subscription() {
    ...
    <div className="text-center">
      <h1 className="text-[40px] font-bold text-purple-600">Subscription Plans</h1>
      <p className="my-4 text-gray-600 text-[16px] leading-[22.89px]">Select from one of our plans that suit you, your project goals and team</p>
    </div>
