      ...
      <div className="bg-[#0F1117] dark:bg-[#0F1117] py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            ...
            <div className="border-2 border-[#2A2E3A] rounded-lg p-6 flex flex-col relative bg-[#1A1D29] dark:bg-[#1A1D29] text-white dark:text-white shadow-md">
            ...
            <div className="border-2 border-[#4BF29C] rounded-lg p-6 flex flex-col bg-[#1A1D29] dark:bg-[#1A1D29] text-white dark:text-white shadow-md">
              <div className="flex items-center mb-4">
                <div className="flex justify-between items-center w-full">
                  <div className="bg-[#151925] dark:bg-[#151925] text-[#4BF29C] dark:text-[#4BF29C] rounded-full p-2 flex items-center justify-center">
                    <MarketerSuiteIcon />
