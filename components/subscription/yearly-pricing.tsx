      ...
      <div className="bg-[#0F1117] dark:bg-[#0F1117] py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            ...
            <div className="border-2 border-purple-600 dark:border-purple-600 rounded-lg p-6 flex flex-col relative bg-[#1A1D29] dark:bg-[#1A1D29] text-white dark:text-white">
              ...
              <p className="text-4xl font-bold text-white dark:text-white">€25</p>
              <p className="text-gray-400 dark:text-gray-400 text-sm">/ Month (Billed annually)</p>
            ...
            <div className="border-2 border-purple-600 dark:border-purple-600 rounded-lg p-6 flex flex-col bg-[#1A1D29] dark:bg-[#1A1D29] text-white dark:text-white">
              <div className="flex items-center mb-4">
                <div className="flex justify-between items-center w-full">
                  <div className="bg-[#2A2D39] dark:bg-[#2A2D39] text-purple-500 dark:text-purple-500 rounded-full p-2 flex items-center justify-center">
                    <MarketerSuiteIcon />
              ...
              <p className="text-4xl font-bold text-white dark:text-white">€90</p>
              <p className="text-gray-400 dark:text-gray-400 text-sm">/ Month (Billed annually)</p>
              <hr className="my-4 border-gray-800 dark:border-gray-800" />
