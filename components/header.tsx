        ...
        {session?.user ? (
          <div className="flex flex-grow justify-between items-center">
            ...
            <div className="flex items-center">
              ...
              <Link
                href="/notifications"
                className={cn(buttonVariants({ variant: 'ghost' }), 'ml-1 sm:ml-4 text-xs sm:text-sm text-text-white hover:text-primary-green hover:bg-dark-bg flex items-center gap-1')}
              >
