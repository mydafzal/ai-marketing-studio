          ...
          <div className="w-full bg-amber-800/20 border-y border-amber-800/30 py-1 px-4 relative z-50">
            <div className="flex items-center justify-center">
              ...
              <div className="relative inline-block ml-1 group">
                ...
                <div className="absolute top-full left-0 mt-2 w-64 bg-black text-white text-xs rounded py-2 px-3 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                  ...
                  <div className="absolute bottom-full left-2 transform -translate-x-1/2 -mb-1 border-b-4 border-black"></div>
                </div>
              </div>
            </div>
          </div>
