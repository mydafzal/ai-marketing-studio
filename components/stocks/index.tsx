...
export { BotCard, BotMessage, SystemMessage, SystemErrorMessage } from './message'
...
const Purchase = dynamic(
  () => import('./set-budget').then(mod => mod.Purchase),
  {
    ssr: false,
    loading: () => (
      <div className="h-[375px] rounded-xl border bg-zinc-950 p-4 text-green-400 sm:h-[312px]" />
    )
  }
)
