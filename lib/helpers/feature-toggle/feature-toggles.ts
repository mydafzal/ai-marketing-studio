...
export const featureToggles: FeatureToggle[] = [
  {
    name: 'demoToggle',
    description:
      'For checking feature toggle functionality on demo page (feature toggle health check)'
  },
  {
    name: 'adminFeatures',
  ...
  },
  {
    ...
    description:
      "Show the floating button 'Things to ask Reeply AI' on the chat panel"
  },
  {
  ...
  {
    name: 'campaignInitiatorCard',
    description:
      'Show the campaign initiator on the right hand side of the chat'
  }
