      ...
      <div className="flex flex-col space-y-4 sm:space-y-6">
        <div className="flex flex-col space-y-2 sm:space-y-3">
          <div className="flex items-center justify-between">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Campaign Creator</h1>
          </div>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 sm:gap-3">
            <p className="text-xs sm:text-sm text-muted-foreground md:max-w-lg">
              Create professional Facebook and Instagram ad campaigns
            </p>
          </div>
        </div>

        <div className="w-full shadow-sm rounded-lg border bg-card p-4 md:p-6">
          <CreateCampaignForm />
        </div>
      </div>
    </div>
