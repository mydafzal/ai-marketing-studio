...
export async function GET(request: Request) {
  ...
  redirectUrl.searchParams.append('scope', 'ads_read,ads_management,pages_manage_ads,business_management,pages_show_list,leads_retrieval'); // Add scopes as per requirement
